...
export const OCR_PAGE_TIMEOUT_MS = parseInt(process.env.OCR_PAGE_TIMEOUT_MS || '18000', 10); // 18s per page timeout
export const MAX_TOTAL_OCR_TIMEOUT_MS = parseInt(process.env.MAX_TOTAL_OCR_TIMEOUT_MS || '55000', 10); // 55s total budget for synchronous OCR
export const MAX_OCR_PAGES = parseInt(process.env.MAX_OCR_PAGES || '4', 10); // Max 4 scanned pages processed synchronously to avoid HTTP timeouts
